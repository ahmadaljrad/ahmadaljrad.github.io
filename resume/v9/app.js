...
const Controller = (() => {
  ...
  function initPdf() {
    function doPrint() {
      // Reset any style that could create whitespace in print
    ...
    const printMobile = document.getElementById('btn-print-mobile');
    if (printMobile) {
      printMobile.addEventListener('click', () => {
        // Hide the mobile panel overlay before printing
...
const MobilePreview = (() => {
  ...
  function init() {
    ...
    /* PDF button in mobile bar — handled by initPdf() */
